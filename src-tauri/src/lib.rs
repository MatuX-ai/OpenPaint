...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            tools::canvas_commands::rotate_layer,
            tools::canvas_commands::add_text,
            tools::canvas_commands::paste_text_bitmap,
            tools::canvas_commands::set_layer_blend_mode,
            ...
            tools::canvas_commands::set_layer_locked,
            tools::canvas_commands::set_layer_opacity,
            tools::canvas_commands::set_layer_blend_mode,
